...
def mostrar_nombre_y_altura():
    for personaje in lista_personajes:
        personaje["altura"] = float(personaje["altura"])
        print(
            "Nombre: {0} | Altura: {1:.2f}".format(
                personaje["nombre"], personaje["altura"]
            )
        )
...
def calcular_mas_alto():
    ...
    print(
        "El superheroe mas alto es: {0}, y su altura es de: {1} ".format(
            personaje_mas_alto["nombre"], personaje_mas_alto["altura"]
        )
    )
...
def calcular_mas_bajo():
    ...
    print(
        "El superheroe mas bajo es: {0}, y su altura es de: {1} ".format(
            personaje_mas_bajo["nombre"], personaje_mas_bajo["altura"]
        )
    )
...
def calcular_promedio_altura():
    ...
    print(
        "La altura promedio de los superhéroes es: {0:.2f}".format(
            acumulador_altura / len(lista_personajes)
        )
    )
...
def calcular_mas_menos_pesado():
    ...
    print(
        "\nEl superheroe mas pesado es: {0}, y su peso es: {1} \nEl superheroe menos pesado es {2}, y su peso es: {3} ".format(
            personaje_mas_pesado["nombre"],
            personaje_mas_pesado["peso"],
            personaje_menos_pesado["nombre"],
            personaje_menos_pesado["peso"],
        )
    )
